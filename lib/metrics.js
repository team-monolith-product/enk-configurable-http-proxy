...
export class Metrics {
  constructor() {
    ...
    this.llmProbeCount = new client.Counter({
      name: "llm_probe_total",
      help: "Count of LLM provider health probes by result",
      labelNames: ["provider", "result"],
      registers: [this.register],
    });

    this.llmProviderStatus = new client.Gauge({
      name: "llm_provider_status",
      help: "Current LLM provider health status (1 for the active status)",
